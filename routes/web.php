...
$router->group(['middleware' => 'auth'], function () use ($router){
    ...
    $router->group(['prefix' => 'clearance', 'middleware'], function () use ($router){
        $router->post('approve', [\App\Http\Controllers\ClearanceRequestController::class, 'update']);
        $router->post('reject', [\App\Http\Controllers\ClearanceRequestController::class, 'reject']);
    });
